...
from google.cloud.bigquery_connection_v1.services.connection_service import ConnectionServiceClient
...
def test_create_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "post_create_connection") as post, \
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "pre_create_connection") as pre:
...
def test_get_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "post_get_connection") as post, \
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "pre_get_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_connections_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "post_list_connections") as post, \
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "pre_list_connections") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "post_update_connection") as post, \
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "pre_update_connection") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_connection_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "pre_delete_connection") as pre:
        pre.assert_not_called()
...
def test_get_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "post_get_iam_policy") as post, \
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "pre_get_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_set_iam_policy_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "post_set_iam_policy") as post, \
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "pre_set_iam_policy") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_test_iam_permissions_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "post_test_iam_permissions") as post, \
         mock.patch.object(transports.ConnectionServiceRestInterceptor, "pre_test_iam_permissions") as pre:
        pre.assert_not_called()
        post.assert_not_called()
